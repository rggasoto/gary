...
def tCallback(event):
    ...
    odom_list.waitForTransform('map', 'base_footprint', rospy.Time(0), rospy.Duration(1.5))
...
if __name__ == '__main__':
    rospy.init_node('rbe502_test')
    global pub
    global pose
    global odom_list
    #global odom_tf
    pose = Pose()
    pub = rospy.Publisher('/azcar_sim/cmd_vel', Twist, None, queue_size=10) # Publisher for commanding robot motion
    ...
    sub = rospy.Subscriber('azcar_sim/odom', Odometry, readOdom)
